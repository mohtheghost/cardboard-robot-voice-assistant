/*
 * ESP32 VOICE ASSISTANT - 8kHz Optimized with Teacher Feedback!
 * ✅ 8kHz sample rate - 50% less bandwidth for mobile hotspot!
 * ✅ Dynamic VAD - Background calibration + 350 offset
 * ✅ Speech-ended feedback - 3 quick beeps when server stops listening
 * ✅ Mic pause during TTS - Prevents self-recording!
 * ✅ Improved wake words - "مساعد" (main) + "مساعدي" (backup)
